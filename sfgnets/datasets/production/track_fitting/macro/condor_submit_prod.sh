...
# Submit the jobs to condor, creates the temporary geant4 macros and attribute a particle (a specific macro) to each job
# Usage: bash condor_submit_prod.sh [imin to start from] [imax]
